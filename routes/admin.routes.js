...
router.post('/membership-plans', protect, admin, adminController.createMembershipPlan);
router.post('/membership-plans/:id', protect, admin, adminController.updateMembershipPlan);
router.delete('/membership-plans/:id', protect, admin, adminController.deleteMembershipPlan);
